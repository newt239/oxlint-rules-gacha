...
export const actionStyles = stylex.create({
  ...
  danger: {
    ...
    color: { ":disabled": color.inkDim, default: color.danger },
  },
  dangerSolid: {
    backgroundColor: { ":disabled": color.cabinet2, default: color.danger },
    color: { ":disabled": color.inkDim, default: color.cabinet },
  },
  link: {
